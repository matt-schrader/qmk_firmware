...
[QWERTY_LAYER] = KEYMAP( \
  ...
  KC_LCBR,  CTL_T(KC_LCBR), KC_LALT, KC_LGUI, KC_SPC,  LOWER,   RAISE,   KC_SPC,  KC_RGUI, KC_RALT, CTL_T(KC_RBRC), KC_RCBR  \
),
...
[LOWER_LAYER] = KEYMAP( \
	...
	KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,    KC_UNDS, KC_QUOT, _______, _______, _______, _______, \
 ...
 */
[RAISE_LAYER] = KEYMAP( \
	_______, _______, KC_UP  , _______, _______, _______, KC_PSLS, KC_P7,   KC_P8,   KC_P9,   KC_PAST, _______,  \
	_______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_PMNS, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, _______,  \
