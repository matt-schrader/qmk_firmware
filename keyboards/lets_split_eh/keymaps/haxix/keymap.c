...
[_LOWER] = LAYOUT( \
	...
	KC_1,    KC_2 , KC_3,    KC_4,    KC_5,    KC_6,    KC_UNDS, KC_QUOT, _______, _______, _______, _______, \
 ...
 */
[_ADJUST] = LAYOUT( \
  TSKMGR,  RESET, _______, _______, _______, _______, _______, RGB_MOD, RGB_VAI, RGB_SAI, RGB_HUI, CALTDEL, \
